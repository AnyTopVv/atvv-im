...
public enum ErrorCode {
    ...
    TOKEN_ERROR(20006,"token格式错误"),
    REFRESH_TOKEN_ERROR(20007,"refreshToken格式错误"),
    REFRESH_TOKEN_EXPIRED(20008,"refreshToken已过期"),
    ERROR_REFRESH_USER_TOKEN(20009,"无权限刷新accessToken"),
